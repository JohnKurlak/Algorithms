 ...
 *
 * It uses a modified version of Kadane's Algorithm, and the run-time is
 * O(n).
 *
...
public class SubarrayClosestSum {
    ...
    public static void main(String[] args) {
        ...
        int[] subarray = findSubarrayClosestSum(list, k, inclusive);
     ...
     */
    public static int[] findSubarrayClosestSum(int[] list, int k, boolean inclusive) {
